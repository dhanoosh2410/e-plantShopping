...
function ProductList({ onHomeClick }) {
  ...
  // Toggle between product listing and cart view
  const [showCart, setShowCart] = useState(false);

  // Track which products are added to cart (for disabling button)
  const [addedToCart, setAddedToCart] = useState({});

  // Dynamic cart count for navbar icon
  ...
  // Plants array (NOTE: cost is a STRING like "$15" for CartItem calculations)
  const plantsArray = [
    {
    ...
    },
    {
      ...
      plants: [
        ...
        { name: "Marigold", image: "https://cdn.pixabay.com/photo/2022/02/22/05/45/marigold-7028063_1280.jpg", description: "Natural insect repellent and adds color.", cost: "$8" },
    ...
    },
    {
      ...
      plants: [
        ...
        { name: "Pothos", image: "https://cdn.pixabay.com/photo/2018/11/15/10/32/plants-3816945_1280.jpg", description: "Tolerates neglect and grows easily.", cost: "$10" },
        ...
        { name: "Cast Iron Plant", image: "https://cdn.pixabay.com/photo/2017/02/16/18/04/cast-iron-plant-2072008_1280.jpg", description: "Hardy plant that tolerates neglect.", cost: "$20" },
  ...
  // REQUIRED: dispatch addItem + setAddedToCart(product.name)=true
